 ...
 *      });
      ...
      runner.on('end', function () {
        ...
        if (stats.failures) {
          ...
          notify(stats.passes + ' tests passed in ' + stats.duration + 'ms', {
            name: 'mocha', title: 'Passed', image: image('ok')
          });
        }
      });
    };
  ...
  require.register("reporters/base.js", function (module, exports, require) {
    ...
    exports.colors = {
      'pass': 90, 'fail': 31, 'bright pass': 92, 'bright fail': 91, 'bright yellow': 93, 'pending': 36, 'suite': 0, 'error title': 0, 'error message': 31, 'error stack': 90, 'checkmark': 32, 'fast': 90, 'medium': 33, 'slow': 31, 'green': 32, 'light': 90, 'diff gutter': 90, 'diff added': 42, 'diff removed': 41
    };
...
// With node.js on Windows: use symbols available in terminal default fonts
  ...
  require.register("reporters/json-cov.js", function (module, exports, require) {
    ...
    function map(cov) {
      var ret = {
        instrumentation: 'node-jscoverage', sloc: 0, hits: 0, misses: 0, coverage: 0, files: []
      };
    ...
    function coverage(filename, data) {
      ...
      data.source.forEach(function (line, num) {
        ...
        ret.source[num] = {
          source: line, coverage: data[num] === undefined
            ? ''
            : data[num]
        };
      });
    ...
    function clean(test) {
      return {
        title: test.title, fullTitle: test.fullTitle(), duration: test.duration
      }
    }
  ...
  require.register("reporters/xunit.js", function (module, exports, require) {
    ...
    function XUnit(runner) {
      ...
      runner.on('end', function () {
        console.log(tag('testsuite', {
          name: 'Mocha Tests', tests: stats.tests, failures: stats.failures, errors: stats.failures, skip: stats.tests - stats.failures - stats.passes, timestamp: (new Date).toUTCString(), time: stats.duration / 1000
        }, false));
    ...
    function test(test) {
      var attrs = {
        classname: test.parent.fullTitle(), name: test.title, time: test.duration / 1000
      };
