 ...
 *
 */
define(['ep', 'app', 'eventbus', 'mediator', 'cart.models', 'cart.views', 'text!modules/base/cart/base.cart.templates.html','pace'],
  function (ep, App, EventBus, Mediator, Model, View, template,pace) {
    pace.start();
